...
# Run `pod lib lint appambit_sdk_flutter.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'appambit_sdk_flutter'
  s.version          = '0.0.1'
...
Lightweight SDK for analytics, events, logging, crashes, and offline support. Simple setup, minimal overhead.
  ...
  s.source           = { :path => '.' }
  s.source_files = 'Classes/**/*', 'AppAmbitSdkSources/**/*.swift'
  s.dependency 'Flutter'
  s.platform = :ios, '13.0'

  # Locally testing AppAmbitSdk without CocoaPods:
